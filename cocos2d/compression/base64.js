 ...
 * </p>
 * @function
 * @param {String} input The base64 encoded string to decode 参数{String} 输入要解码的base64编码字符串
 * @return {String} Decodes a base64 encoded String 返回值{String}解码后的base64编码的字符串
 * @example 例如
 * //decode string 解码字符串
 ...
 * </p>
 * @function
 * @param {String} input The String to convert to an array of Integers 参数{String} 输入要转换的字符串，转换为整型数组
 * @param {Number} bytes 参数{Number} 字节型
 * @return {Array} 返回{Array}
 * @example
 * //decode string to array 将字符串解码为数组
